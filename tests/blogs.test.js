...
const { createPost, deletePost, updatePost, getAllPosts, getSinglePost, likeBlogPost, shareBlogPost, updateViews, addCommentToPost } = require('../controllers/blogsControllers');
...
describe('Blog Controllers', () => {
  ...
  // Test for deletePost controller
  ...
  // Test for updatePost controller
  ...
  // Test for getAllPosts controller
  ...
  // Test for getSinglePost controller
  ...
  // Test for likeBlogPost controller
  ...
  // Test for shareBlogPost controller
  ...
  // Test for updateViews controller
  ...
  // Test for addCommentToPost controller
